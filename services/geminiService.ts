...
export const getAITutorResponse = async (question: string) => {
  try {
    ...
    //   contents: question,
    //   config: {
    //     systemInstruction: "You are an AI tutor for egurukl, managed by MTST SEVA Technologies Pvt. Ltd. Answer educational questions clearly and encourage students.",
    //   },
    // });
