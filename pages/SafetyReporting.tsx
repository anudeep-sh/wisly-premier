      ...
      <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4 py-32">
        <div className="max-w-2xl w-full bg-white rounded-[4rem] p-16 shadow-2xl shadow-gray-200/50 text-center animate-in zoom-in fade-in duration-700">
          ...
          <p className="text-xl text-gray-500 mb-12 font-medium leading-relaxed">
            Your safety concern has been encrypted and sent directly to the MTST SEVA Technologies Pvt. Ltd. Disciplinary Committee. We will investigate and act within 2 hours.
          </p>
          <div className="space-y-4">
            <button 
              onClick={() => setSubmitted(false)}
              className="w-full py-5 bg-blue-600 text-white rounded-[2rem] font-black text-xl hover:bg-red-600 transition-all shadow-2xl shadow-blue-100"
            >
              Back to Portal
            </button>
            <p className="text-sm font-bold text-gray-400 uppercase tracking-widest">Ref ID: EGRU-SAFE-29931</p>
          </div>
        </div>
      </div>
    );
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-5 space-y-10">
            ...
            <h1 className="text-5xl md:text-6xl font-black text-gray-900 mb-8 leading-tight tracking-tight">
              Safety is our <br/><span className="text-red-600">Zero Protocol.</span>
            </h1>
            
            <p className="text-xl text-gray-500 mb-12 font-medium leading-relaxed">
              At egurukl, we foster an environment of radical kindness and absolute safety. If you witness bullying, infrastructure failures, or cyber threats, use this portal.
            </p>
            ...
            <div className="grid grid-cols-1 gap-6">
              {[
                { 
                  ...
                  desc: "Your identity is hidden from all faculty members and only accessible to the MTST SEVA Safety Board.",
                  color: "bg-red-600"
                },
                { 
                  icon: Lock, 
            ...
            <div className="bg-gray-900 p-10 rounded-[3rem] text-white relative overflow-hidden">
              ...
              <h3 className="text-xl font-black mb-4 flex items-center">
                <ShieldCheck className="w-6 h-6 mr-3 text-red-400" />
                Anti-Ragging Squad
              </h3>
              <p className="text-gray-400 font-medium leading-relaxed text-sm">
                Our specialized Anti-Ragging Squad conducts surprise patrols. We are committed to a 100% ragging-free zone under MTST SEVA management.
              </p>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  ...
                  <select 
                    className="w-full px-6 py-5 rounded-[1.5rem] bg-gray-50 border border-transparent focus:bg-white focus:border-red-500 focus:ring-4 focus:ring-red-50 outline-none font-bold text-gray-700 transition-all appearance-none"
                    value={reportType}
              ...
              <div className="space-y-3">
                ...
                <textarea 
                  rows={6}
                  required
                  className="w-full px-6 py-5 rounded-[2rem] bg-gray-50 border border-transparent focus:bg-white focus:border-red-500 focus:ring-4 focus:ring-red-50 outline-none font-bold text-gray-700 transition-all resize-none"
              ...
              <div className="p-8 bg-slate-50 rounded-[2.5rem] border border-slate-100 flex items-start space-x-4">
                ...
                <p className="text-xs text-gray-500 font-bold leading-relaxed">
                  NOTE: By submitting this report, you confirm the details are true. False reporting is subject to disciplinary action by MTST SEVA Technologies Pvt. Ltd.
                </p>
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-6 bg-red-600 text-white rounded-[2.5rem] font-black text-xl hover:bg-blue-600 transition-all flex items-center justify-center space-x-3 shadow-2xl shadow-red-200 group active:scale-95"
              >
                {loading ? (
